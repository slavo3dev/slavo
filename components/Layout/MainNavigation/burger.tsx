	...
	return (
		<div className="sm:hidden flex-row overflow-show">
			<button
				...
				className=" z-50 right-4 items-center py-2 px-3 mt-4 mr-4 text-blue-500 hover:text-blue-700 rounded border border-blue-200 hover:border-blue-300"
			>
				<svg
			...
			<div className={showDrop ? "visible " : "hidden"}>
				<div className="fixed flex-col h-5/6 overflow-scroll bg-white left-0 z-40 mt-2 w-full rounded border-[.5px] border-light px-5 py-5 transition-all">
					<ul className="overflow-y-scroll  mr-auto w-full flex list-none flex-col ">
						<li className="w-11/12 text-sm text-gray-500 rounded-xl">
							<span
								onClick={handleMenu}
								className="relative block hover:text-blue-500 hover:bg-blue-50 w-full p-4 rounded-xl"
							>
								<p>Home</p>
								<div className="absolute right-2 bottom-1">
									{!showHome ? (
										<p className="text-md h-8 w-8 text-center ">+</p>
									) : (
										<p className="absolute right-1 bottom-0.5 text-md h-8 w-8 text-center ">
                      -
										</p>
									)}
								</div>
							...
							<ul
								className={
									showHome ? "flex-col visible" : "invisible absolute"
								}
							>
              ...
              Team
                      ...
                      -
							...
							<ul
								className={
									showBlog ? "flex-col visible" : "invisible absolute"
								}
							>
								<li className="w-11/12 p-4 text-sm text-gray-500 hover:text-blue-500 hover:bg-blue-50 rounded-xl">
                  Blog 1
