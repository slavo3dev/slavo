...
export const Subscribe: FC = () => {
  ...
  const subscribeForm = (
    <div className="flex flex-col md:flex-row flex-wrap max-w-lg mx-auto">
      ...
      <button
        className="w-auto py-4 px-8 text-xs ml-auto mr-auto text-blue-800 hover:text-white font-semibold leading-none border border-blue-300 hover:border-blue-300 bg-white hover:bg-blue-500 rounded transition duration-300 ease-in-out"
        type="submit"
