		...
		<div ref={elementRef} className={`${styles["fade-in"]} ${show ? styles.active : ""}`}>
			<section className="py-20 px-4" id="how-we-work">
					...
					<div className="flex flex-wrap -mx-8">
						<div className="w-full lg:w-1/2 px-8">
							<div className="mb-12 lg:mb-0 pb-12 lg:pb-0 border-b lg:border-b-0">
                                ...
                                Commit<span className="text-blue-600"> to</span> YourPersonal Growth.
								</h2>
             ...
             Working with a team means there will be varying
                ...
                best, you should listen to all ideas before pushing
                yours. Search for compromises, and remain respectful
                if your work is criticized.
								</p>
								<Link href="/services">
                  ...
                  Learn More
						...
						<div className="w-full lg:w-1/2 px-8">
							<ul className="space-y-12">
								<li
									className="flex -mx-4 wow animate__animated animate__fadeIn"data-wow-delay=".3s">
									<div className="px-4">
										<span className="flex w-16 h-16 mx-auto items-center justify-center text-2xl font-bold font-heading rounded-full bg-blue-200 text-blue-600">
                                        1</span>
									</div>
									<div className="px-4">
										<h3 className="my-4 text-xl font-semibold">Project Initialization</h3>
										<p className="text-blueGray-400 leading-loose">
                    Project initiation is the first step in starting a
                    new project. During the project initiation phase,
                    you establish why you are doing the project and
                    what business value it will deliver.
										</p>
									</div>
								</li>
								<li className="flex -mx-4 wow animate__animated animate__fadeIn"
									data-wow-delay=".5s"	>
									<div className="px-4">
										<span className="flex w-16 h-16 mx-auto items-center justify-center text-2xl font-bold font-heading rounded-full bg-blue-200 text-blue-600">
                    2
                    ...
                    routine and doing something different for the sake
                    ...
                    Market Development
										...
										<p className="text-blueGray-400 leading-loose">
                    Market development is a strategic step taken by a
                    company to develop the existing market rather than
