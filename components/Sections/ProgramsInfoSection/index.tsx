export const ProgramsInfoSection = () => {
  return (
              ...
              <div className="flex flex-wrap">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-blueGray-400 leading-loose text-sm">
                      After 7-days of learning, you will be included
                      in the team project & start practicing your
                      skills.
                      <br />
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-blueGray-400 leading-loose text-sm">
                      ...
                      clear awareness of the specific components of a
                      skill we are aiming to improve and exactly how
                      to improve them.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-blueGray-400 leading-loose text-sm">
                      We will provide you best tools and resources to
                      help you
                      <br /> learn new skill, such as free courses,
                      chatbot, mentors, podcasts, books,
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-blueGray-400 leading-loose text-sm">
                      ...
                      new skillset is to constantly practice &
