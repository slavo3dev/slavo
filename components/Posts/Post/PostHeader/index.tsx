...
export const PostHeader: FC<PostHeaderType> = ({ title, imgSrc, category, data}) =>
{   
	return (
		<>
			...
			<header className="max-w-xl mx-auto text-center">
				<nav className="flex items-center justify-center">
					<div className="flex items-center space-x-2">
						<a href="/" title="Home Page" className="text-base font-medium text-gray-900"> Home </a>
						<div className="flex items-center">
							...
							<a href="/blog" title="Blog Page" className="ml-2 text-base font-medium text-gray-900"> Blog </a>
						</div>
						<div className="flex items-center">
							<svg className="w-5 h-5 text-gray-900 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
								<path d="M5.555 17.776l8-16 .894.448-8 16-.894-.448z" />
							</svg>
							<a href="/contact" title="Contact us" className="ml-2 text-base font-medium text-gray-500"> Contact us </a>
						</div>
					</div>
				</nav>
				<div className="max-w-xl mx-auto text-center">
					...
					<div className="flex items-center justify-center mt-8 space-x-2">
						<p className="text-base font-medium text-gray-900">
							<a href={ `/category/${category}` } title="" className="">{ category }</a>
						</p>
