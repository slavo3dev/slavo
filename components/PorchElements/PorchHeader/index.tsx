...
import QuoteSwitcher from "@/components/PorchElements/PorchQuotes";
...
export const PorchHeader: React.FC<PorchHeaderProps> = ({
  showForm,
  setShowForm,
}) => {
      ...
      <div className="flex flex-row items-center">
        ...
        >
          <span className="flex text-black font-bold ">
            {showForm ? <IoMdClose /> : <MdOutlineTrendingUp />}{" "}
          </span>
        </button>
        <p className="pl-2 pb-6">
          <GoArrowLeft />
        </p>
        <p className="pl-2 pb-6 text-xs">
          Post your{" "}
